...
- [x] I am on feature branch `docs/first-contribution-brayden` (not the default branch).
- [x] `CONTRIBUTORS.md` lists my name and GitHub handle in a consistent format.
- [x] Any second touch is limited to `docs/onboarding/repo-map.md` and does not change behavior beyond copy/docs.
